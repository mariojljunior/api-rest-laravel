        ...
        <div class="box">
            <form action="{{ route('salvar_enderecos') }}" method="POST">
                ...
                <div for="telefone" class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" placeholder="telefone" name="telefone" id="telefone" data-js="telefone">
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" placeholder="cpf_cnpj" name="cpf_cnpj" id="cpf_cnpj" maxlength="14">
                    </div>
                </div>
